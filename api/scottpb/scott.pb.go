...
type Header struct {
	...
	MaxInventory  int32 `protobuf:"varint,5,opt,name=max_inventory,json=maxInventory,proto3" json:"max_inventory,omitempty"`    // maximum number of inventory items
	StartingRoom  int32 `protobuf:"varint,6,opt,name=starting_room,json=startingRoom,proto3" json:"starting_room,omitempty"`    // 0-based index of initial room
	NumTreasures  int32 `protobuf:"varint,7,opt,name=num_treasures,json=numTreasures,proto3" json:"num_treasures,omitempty"`    // number of treasures (technically redundant)
	WordLength    int32 `protobuf:"varint,8,opt,name=word_length,json=wordLength,proto3" json:"word_length,omitempty"`          // word length (3, 4, 5)
	LightDuration int32 `protobuf:"varint,9,opt,name=light_duration,json=lightDuration,proto3" json:"light_duration,omitempty"` // number of turns for light, or -1 for eternal
	NumMessages   int32 `protobuf:"varint,10,opt,name=num_messages,json=numMessages,proto3" json:"num_messages,omitempty"`      // number of messages
	TreasureRoom  int32 `protobuf:"varint,11,opt,name=treasure_room,json=treasureRoom,proto3" json:"treasure_room,omitempty"`   // 0-based index of treasure room for scoring
	Unknown12     int32 `protobuf:"varint,12,opt,name=unknown12,proto3" json:"unknown12,omitempty"`                             // unknown purpose (bytes 26-27)
}
...
var file_scott_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x74, 0x74, 0x22, 0x9c, 0x03, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12,
	...
	,
	...
	,
}
